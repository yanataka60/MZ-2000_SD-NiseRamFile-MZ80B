...
#define TXCOUNT (640*200) // Total pixels/2 (since we have 2 pixels per byte)

//#define TXCOUNT_LINE 320 // Total pixels/2 for 1 line (since we have 2 pixels per byte)
#define TXCOUNT_LINE 640 // Total pixels/2 for 1 line (since we have 2 pixels per byte)
